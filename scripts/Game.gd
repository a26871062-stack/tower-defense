...
@onready var speed_down_btn = $UI/TopBar/SpeedDownButton
@onready var speed_label = $UI/TopBar/SpeedLabel
@onready var speed_up_btn = $UI/TopBar/SpeedUpButton
@onready var pause_btn = $UI/TopBar/PauseButton
